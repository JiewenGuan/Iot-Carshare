...
====================
This module defines the data models that are used by the 
database and served by the API. At this stage that is via three 
...
the socket queries from an Agent.
